...
public:
    ...
    int64_t getCountElements();         // получить количество элемнтов в списке
    ...
    int64_t FindElement(T);             // поиск по значению
...
private:
    int64_t countElements; // количество элемнтов в списке
    struct Node
    {
        T info;
        Node *next;
